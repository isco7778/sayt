  ...
  return (
    <>
        <div className="nav">
            ...
            <ul className='ul'>
                <li > 
                  <NavLink to="/Men"></NavLink> Men
                </li>
                <li > 
                  <NavLink to="/Woman"></NavLink> Woman
               </li>
                <li >
                   <NavLink to="/Kids"></NavLink> Kids
                </li>
                <li > 
                  <NavLink to="/Sale"></NavLink> Sale
                </li>
                <li >
                   <NavLink to="/NewTrending"></NavLink> NewTrending
                </li>
